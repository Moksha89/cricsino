...
<template>
    <div>
                        ...
                        <div class="flex">
                            ...
                            <label class="inline-flex items-center space-x-2">
                                <input
                                    ...
                                    class="form-switch h-5 w-10 rounded-full bg-slate-300 before:rounded-full before:bg-slate-50 checked:!bg-primary-dark checked:before:bg-white dark:bg-navy-900 dark:before:bg-navy-300 dark:checked:before:bg-white"
                                    type="checkbox"
                                />
        ...
        <div class="mt-6 flex justify-end">
            <PrimaryButton @click.prevent="updateProfilePhoto" primary>
                <Loading v-if="form.processing" class="mr-2 -ml-1" />
                {{ $t("Update Profile Photo") }}</PrimaryButton
            >
        </div>
    </div>
</template>
