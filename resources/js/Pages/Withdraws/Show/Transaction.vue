...
<template>
	<div class="bg-gray-800/50 border border-white/[0.06] rounded-lg shadow-md p-6">
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div class="space-y-2">
				...
				<p
					class="text-lg uppercase font-semibold text-white">
					{{ withdraw.uid }}
				</p>
			</div>
			...
			<div class="space-y-2 md:col-span-2">
				...
				<p
					class="md:text-lg text-sm font-semibold text-white">
					{{ withdraw.to }}
				</p>
			</div>
		</div>
		...
		<div
			...
			<div class="mt-6 space-y-2" v-if="withdraw.withdraw_address">
				...
				<p
					class="text-lg font-semibold text-white break-all">
