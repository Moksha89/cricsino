...
<template>
	<UserLayout>
		<div class="p-4 sm:p-6 mb-12">
			...
			<div
				class="py-2 px-4 text-gray-400 flex flex-col sm:flex-row sm:justify-between rounded border border-dashed border-gray-350 dark:border-gray-750 bg-gray-800/50 border border-white/[0.06]/50">
				<WeCopy
					after
						...
						<tbody role="rowgroup">
							<tr
								...
								<td
									...
									:key="i"
									class="px-6 py-4 uppercase text-xs whitespace-nowrap bg-gray-800/50 border border-white/[0.06] font-medium text-gray-900 dark:text-gray-300">
									{{ lvl.type }} :
									<span
