    ...
    public function run(): void
    {
        ...
        $config = [
            ...
            'mail' => [
                ...
                'balance_withdraw_message' =>  'Your withdraw request for :amount :symbol has been processed in your account. Your new balance is :balance :symbol',
                'balance_withdraw_subject' =>  '[:appname] :symbol withdraw processed',
                'balance_withdraw_salutation' =>  ':symbol withdraw :status',
            ...
            'sms' => [
                ...
                'balance_withdraw_message' =>  'withdraw :amount :symbol processed. status :status',
